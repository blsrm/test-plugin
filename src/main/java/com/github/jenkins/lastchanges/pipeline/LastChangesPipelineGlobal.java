...
public class LastChangesPipelineGlobal implements Serializable {
    ...
    public LastChangesPublisherScript getLastChangesPublisher(String since,
        ...
        stepVariables.put("triggerQAJob", triggerQAJob);
        stepVariables.put("qaJenkinsBaseUrl", qaJenkinsBaseUrl);
        stepVariables.put("defaultQaJob", defaultQaJob);
