...
//        project.setScm(scm);
//        LastChangesPublisher publisher = new LastChangesPublisher(SinceType.PREVIOUS_REVISION, FormatType.LINE,MatchingType.NONE, true, false, "0.50","1500",null,null, null,true,null,null,null);
...
//        FreeStyleProject project = jenkins.createFreeStyleProject("git-test");
//        project.setScm(scm);
//        LastChangesPublisher publisher = new LastChangesPublisher(SinceType.PREVIOUS_REVISION, FormatType.LINE,MatchingType.NONE, true, false, "0.50","1500",null,"git-sample-repo", null,true,null,null,null);
//        project.getPublishersList().add(publisher);
//        project.save();
//
//        // when
...
//        FreeStyleProject project = jenkins.createFreeStyleProject("git-test");
//        project.setScm(scm);
//        LastChangesPublisher publisher = new LastChangesPublisher(SinceType.LAST_SUCCESSFUL_BUILD, FormatType.LINE,MatchingType.NONE, true, false, "0.50","1500",null,null, null,true,null,null,null);
//        project.getPublishersList().add(publisher);
//        project.save();
//
//        // when
...
//
//
//        publisher = new LastChangesPublisher(SinceType.PREVIOUS_REVISION, FormatType.LINE,MatchingType.NONE, true, false, "0.50","1500",null,null, build.getNumber()+"",true,null,null,null);
//
...
//        FreeStyleProject project = jenkins.createFreeStyleProject("git-test");
//        project.setScm(scm);
//        LastChangesPublisher publisher = new LastChangesPublisher(SinceType.PREVIOUS_REVISION, FormatType.LINE,MatchingType.NONE, true, false, "0.50","1500",null,null, "99",true,null,null,null);
//        project.getPublishersList().add(publisher);
//        project.save();
//
//        // when
...
//        project.setScm(scm);
//        LastChangesPublisher publisher = new LastChangesPublisher(SinceType.PREVIOUS_REVISION, FormatType.SIDE,MatchingType.WORD, true, false, null,null,null,null, null,true,null,null,null);
//        project.getPublishersList().add(publisher);
//        project.save();
//
//        // when
